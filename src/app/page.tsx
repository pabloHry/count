      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Generate dynamic countdown GIFs for your email campaigns. Works with
            Mailchimp, SendGrid, and any email platform that supports images.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
            ...
            <p className="text-sm text-gray-400 mt-4 text-center">
              This GIF updates in real-time when loaded. Each frame shows the
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">
                When a recipient opens your email, their email client requests
                the GIF from this server.
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-purple-600 rounded-full flex items-center justify-center mx-auto mb-3 text-xl font-bold text-white">
              ...
              <p className="text-gray-300 text-sm">
                The server calculates the current time remaining and generates a
                fresh 60-second animated GIF.
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-purple-600 rounded-full flex items-center justify-center mx-auto mb-3 text-xl font-bold text-white">
              ...
              <p className="text-gray-300 text-sm">
                The GIF shows a 60-second countdown animation. Each email open
                gets an updated GIF.
              </p>
            </div>
          </div>
        ...
        <div className="mt-12 text-center text-gray-400 text-sm">
          ...
          <p className="mt-2">
            To change the target date, edit the{" "}
            <code className="bg-gray-800 px-1 py-0.5 rounded">TARGET_DATE</code>{" "}
            constant in{" "}
            <code className="bg-gray-800 px-1 py-0.5 rounded">
              src/app/api/countdown-gif/route.ts
            </code>
          </p>
        </div>
      </div>
